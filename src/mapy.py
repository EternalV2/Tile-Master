    ...
    def __init__(self, tile_size, map_size):
        ...
        for row in range(self.num_rows):
            for col in range(self.num_cols):
                self.tiles[row][col] = Tile(col * self.tile_size, row * self.tile_size, self.tile_size, [0,0,0], f"/Users/royhouwayek/Documents/WorkSpaces/pyTutor/game2d/stable/{MAP_NAME}/_16/gold_16.png", False)
        ...
        for row in range(self.num_rows):
            for col in range(self.num_cols):
                if self.tiles[row][col] is None:
                    self.tiles[row][col] = Tile(col * self.tile_size, row * self.tile_size, self.tile_size, self.generate_tile_color(row, col), "/Users/royhouwayek/Documents/WorkSpaces/pyTutor/game2d/img/_10/gold_10.png", False)
        ...
        for i in range(len(string_array)): 
            ...
            for j in range(len(again)):
                ...
                if again[j] == "None":
                    ...
                    temp_tile = Tile(temp_x, temp_y, temp_size, [0,0,0], "/Users/royhouwayek/Documents/WorkSpaces/pyTutor/game2d/stable/" + MAP_NAME + "/_16/" + temp_name, temp_walkable)
