...
class Brush():
    ...
    def draw(self, undo_stack, full_map, current_frame):
        ...
        if self.mode == "":
            ...
            drawRectOne(self.x, self.y, self.size, self.image, self.name, full_map, current_frame)
            

        # DOES NOT HANDLE CURRENT_FRAME LINE DRAWS TO BASE MAP (FRAME 0)
        elif self.mode == "line":
