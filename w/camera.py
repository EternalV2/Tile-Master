...
class Camera:
    ...
    def addE(self, obj, screen):
        ...
        obj.rect.center = [((obj.x * 10) - self.anchor[0] - self.gimble[0]), ((obj.y * 10) - self.anchor[1] - self.gimble[1])]
    ...
    def addMap(self, base, full_map):
        ...
        for row in range(0, MAP_RC[1], 1):
            for col in range(0, MAP_RC[0], 1):
                full_map.tiles[row][col].rect.center = [(col * 10) - self.anchor[0] - self.gimble[0], (row * 10) - self.anchor[1] - self.gimble[1]]
