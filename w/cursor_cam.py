            ...
            for col in range(0, MAP_RC[0], 1):
                if cursorNotInMap:
                    ...
                    if row == self.coord[1] and col == self.coord[0]:
                        ...
                        drawRectOne(row, col, brush_size, pygame.image.load(f"/Users/royhouwayek/Documents/WorkSpaces/pyTutor/game2d/img/gold_{TILE_SIZE}.png"), "/Users/royhouwayek/Documents/WorkSpaces/pyTutor/game2d/img/gold_10.png", full_map.tiles)
